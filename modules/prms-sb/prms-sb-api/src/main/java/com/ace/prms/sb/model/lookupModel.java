...
/**
 * The base model interface for the lookup service. Represents a row in the &quot;prms_lookup&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ace.prms.sb.model.impl.lookupModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ace.prms.sb.model.impl.lookupImpl</code>.
 * </p>
 *
...
public interface lookupModel
	extends BaseModel<lookup>, GroupedModel, ShardedModel, StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a lookup model instance should use the {@link lookup} interface instead.
	 */
