...
/**
 * Provides the local service interface for lookup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see lookupLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface lookupLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link lookupLocalServiceUtil} to access the lookup local service. Add custom service methods to <code>com.ace.prms.sb.service.impl.lookupLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
